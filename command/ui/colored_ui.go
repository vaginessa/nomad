...
type UiColorWhen int

//go:generate stringer -trimprefix=UiColor -output=colored_ui_string_uicolorwhen.go -linecomment -type=UiColorWhen
const (
	UiColorAuto UiColorWhen = iota
	UiColorNever
	UiColorAlways
)
