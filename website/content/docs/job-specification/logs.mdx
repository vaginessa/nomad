...
amount of logs on disk, you may want to increase ephemeral disk size as wekk. See
...
[ephemeral disk documentation]: /docs/job-specification/ephemeral_disk 'Nomad ephemeral disk Job Specification'
